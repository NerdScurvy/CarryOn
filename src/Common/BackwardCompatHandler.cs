...
namespace CarryOn.Common
{
    ...
    public class BackwardCompatHandler
    {
        ...
        {
            var oldStackAttributeID = $"{CarrySystem.ModId}:CarriedBlock/Stack";
            var oldDataAttributeID = $"{CarrySystem.ModId}:CarriedBlock/Data";
        ...
        {
            var oldAttributeID = $"{CarrySystem.ModId}:CarriedBlock";
